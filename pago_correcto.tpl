<div class="pago" style="min-height: 100px; margin-top: 22px;">
    ...
    <br/>
    <p>
        <a href="{$base_dir_ssl}history.php" title="{l s='Pedidos'}">
            <img src="{$img_dir}icon/order.gif" alt="{l s='Orders'}" class="icon" />{l s='Click here to check your order details' mod='servired'}
        </a>
    </p>
    <br/>
    <p>
